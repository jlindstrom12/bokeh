...
export type BandData = GlyphData & p.UniformsOf<Band.Mixins> & {
...
export interface BandView extends BandData {}
...
export class BandView extends GlyphView {
  ...
  protected _render(ctx: Context2d, _indices: number[], data?: BandData): void {
    const {lower_sx, lower_sy, upper_sx, upper_sy} = data ?? this
